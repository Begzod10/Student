...
from .models import Jobs, OrganizationType, OrganizationDegrees, Organization, File, OrganizationGallery, \
    OrganizationFields, OrganizationLandingPage, OrganizationAdvantage, OrganizationUser
...
class OrganizationLandingPageAdmin(admin.ModelAdmin):
    list_display = ['organization', 'year', 'expire_date', 'start_date', 'degree', 'deleted',
                    'grant', 'price']
