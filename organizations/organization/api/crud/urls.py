...
from organizations.organization.api.crud.create import OrganizationCreateApiView, OrganizationDestroyApiView
...
urlpatterns = [
    ...
    path('delete/<pk>/', OrganizationDestroyApiView.as_view(), name='delete'),
